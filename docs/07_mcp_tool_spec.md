...
| **名前** | `search_all` |
| **説明** | 複数ソースを並列検索し統合比較 |
| **パラメータ** | `query: str` (必須), `sources: str = "hf,gemini,local,files"` |
...
{
  "query": "...",
  "sources_queried": ["HF", "Gemini", "Local", "Files"],
  "source_results": { "HF": {...}, "Local": {...}, ... },
  "all_references": [ ... ],
  "comparison": { "common_themes": [...], "summary": "..." },
  "integrated_report": "## 📊 統合検索レポート\n..."
}
```
...
| `search_all` | `search_all` | sources パラメータ値を変更 |
